  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 w-full flex flex-col gap-8 z-10 relative">
      ...
      <div className="text-center flex flex-col items-center gap-2">
        <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-indigo-500/10 text-indigo-650 dark:text-indigo-400 text-[10px] font-bold">
          <Award className="w-3.5 h-3.5" />
          Unstop Sourcing Platform
        </div>
        <h2 className="text-2xl sm:text-4xl font-extrabold text-slate-850 dark:text-white leading-tight">Student Opportunities</h2>
            ...
            >
              ...
              <div className="p-5 flex flex-col gap-4 flex-1 justify-between">
                ...
                <div className="flex items-center justify-between gap-4 mt-2">
                  <div className="flex items-center gap-3 text-[9px] font-bold text-slate-450 dark:text-slate-450">
                  ...
                  <button
                    onClick={() => handleRegister(opp.title)}
