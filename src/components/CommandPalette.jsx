          ...
          <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
            ...
            >
              ...
              <div className="flex items-center gap-3 px-3 py-2 border-b border-slate-100 dark:border-navy-800">
                ...
                <button
                  onClick={() => setIsOpen(false)}
                  className="text-[10px] font-bold text-slate-400 dark:text-slate-550 border border-slate-200 dark:border-navy-800 rounded px-1.5 py-0.5"
                >
                  ESC
                </button>
              </div>
              ...
              <div className="flex flex-col gap-1 max-h-72 overflow-y-auto pr-1 no-scrollbar">
                {filteredCommands.length > 0 ? (
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          <p className="text-xs font-semibold text-slate-850 dark:text-slate-200 truncate">{cmd.name}</p>
                  ...
                  <div className="text-center py-8">
                    <p className="text-sm font-semibold text-slate-550 dark:text-slate-400">No commands found</p>
