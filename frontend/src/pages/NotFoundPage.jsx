    ...
    <div className="flex-1 flex flex-col items-center justify-center text-center p-6 min-h-[50vh] relative z-10">
      ...
      <div className="flex flex-col items-center gap-6 max-w-md relative z-10">
        ...
        <div className="flex gap-4 w-full justify-center">
          <button
            onClick={() => navigate(-1)}
            className="flex-1 max-w-[150px] py-2.5 rounded-xl border border-slate-200 dark:border-navy-800 bg-white/40 dark:bg-navy-900/40 hover:bg-slate-100 dark:hover:bg-navy-800 text-xs font-bold text-slate-700 dark:text-slate-200 flex items-center justify-center gap-1.5 transition-all"
          >
